...
--
-- Host: localhost
-- Generation Time: Dec 31, 2019 at 03:54 AM
...
CREATE TABLE `absence_logs` (
  ...
  `status_mulai` enum('hadir','telat','alpha','izin','sakit') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_akhir` enum('hadir','telat','alpha','izin','sakit') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(34, '2019-12-17', 'public/hasil/frL14pyq3L1myN9y8jszBhkLrHnVF6KLPCBNzaPw.png', 'A', 1, '2019-12-17 02:39:19', '2019-12-17 02:39:19');
...
(26, 34, 1, '2019-12-17 02:39:19', '2019-12-17 02:39:19');
...
--
-- Table structure for table `membertim`
--

CREATE TABLE `membertim` (
  `id` int(10) UNSIGNED NOT NULL,
  `tim_id` int(10) UNSIGNED NOT NULL,
  `mahasiswa_id` int(10) UNSIGNED NOT NULL,
  `peran_id` int(10) UNSIGNED NOT NULL,
  `tanggung_jawab` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `final_skor` double NOT NULL DEFAULT 0,
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Scrum Master',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `project` (
  ...
  `scrummaster_id` int(10) UNSIGNED NOT NULL,
  `tim_id` int(10) UNSIGNED DEFAULT NULL,
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Project Owner',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sprint` (`id`, `nama_sprint`, `desc_sprint`, `tgl_mulai`, `tgl_selesai`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Sprint 1', 'Membuat Page 1 jadi', '2019-10-10', '2019-10-12', NULL, NULL, '0000-00-00 00:00:00'),
(2, 'Sprint 2', 'Membuat halaman 2 jadi', '2019-10-17', '2019-10-24', NULL, NULL, '0000-00-00 00:00:00');
...
(1, 1, 'Contoh', 1, NULL, NULL, '0000-00-00 00:00:00');
...
CREATE TABLE `users` (
  ...
  `prodi` enum('ti','si') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kelompok` int(11) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `nim`, `password`, `pin`, `role`, `prodi`, `kelompok`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Muhammad Azhar Rasyad', '0110217029', '$2y$10$X3siEzjJM.v5sEf7BbSStOwIJUWkq7eR9rQlL1y7lb0viNkH/tG0u', NULL, 'admin', 'ti', 1, '6OvTKcnC0lnj4mA3FGFWomtUR2zgHdnJPsqxwmKLIewmpjJTkrbKu7qprG2M', '2019-12-17 01:21:24', '2019-12-17 01:21:24');
...
ALTER TABLE `absence_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `absence_logs_sprint_id_foreign` (`sprint_id`),
  ADD KEY `absence_logs_user_id_foreign` (`user_id`);
...
--
-- Indexes for table `membertim`
--
ALTER TABLE `membertim`
  ADD PRIMARY KEY (`id`),
  ADD KEY `membertim_tim_id_foreign` (`tim_id`),
  ADD KEY `membertim_mahasiswa_id_foreign` (`mahasiswa_id`),
  ADD KEY `membertim_peran_id_foreign` (`peran_id`);
...
ALTER TABLE `mvp`
  ADD PRIMARY KEY (`id`),
  ADD KEY `mvp_project_id_foreign` (`project_id`);
...
ALTER TABLE `nilai_kelompok`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nilai_kelompok_sprint_id_foreign` (`sprint_id`);
...
ALTER TABLE `project`
  ADD PRIMARY KEY (`id`),
  ADD KEY `project_semester_id_foreign` (`semester_id`),
  ADD KEY `project_scrummaster_id_foreign` (`scrummaster_id`),
  ADD KEY `project_tim_id_foreign` (`tim_id`);

--
-- Indexes for table `scrummaster`
--
...
ALTER TABLE `tasks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sprint_id` (`sprint_id`),
  ADD KEY `kesulitan_id` (`kesulitan_id`);
...
ALTER TABLE `tim`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tim_semester_id_foreign` (`semester_id`),
  ADD KEY `tim_prodi_id_foreign` (`prodi_id`);
...
--
-- AUTO_INCREMENT for table `membertim`
--
ALTER TABLE `membertim`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `scrummaster`
--
ALTER TABLE `scrummaster`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `absence_logs`
  ADD CONSTRAINT `absence_logs_sprint_id_foreign` FOREIGN KEY (`sprint_id`) REFERENCES `sprints` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `absence_logs_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `membertim`
--
ALTER TABLE `membertim`
  ADD CONSTRAINT `membertim_mahasiswa_id_foreign` FOREIGN KEY (`mahasiswa_id`) REFERENCES `mahasiswa` (`id`),
  ADD CONSTRAINT `membertim_peran_id_foreign` FOREIGN KEY (`peran_id`) REFERENCES `peran` (`id`),
  ADD CONSTRAINT `membertim_tim_id_foreign` FOREIGN KEY (`tim_id`) REFERENCES `tim` (`id`);

--
-- Constraints for table `mvp`
--
ALTER TABLE `mvp`
  ADD CONSTRAINT `mvp_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`);

--
-- Constraints for table `nilai_kelompok`
--
ALTER TABLE `nilai_kelompok`
  ADD CONSTRAINT `nilai_kelompok_sprint_id_foreign` FOREIGN KEY (`sprint_id`) REFERENCES `sprints` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `project`
--
ALTER TABLE `project`
  ADD CONSTRAINT `project_scrummaster_id_foreign` FOREIGN KEY (`scrummaster_id`) REFERENCES `scrummaster` (`id`),
  ADD CONSTRAINT `project_semester_id_foreign` FOREIGN KEY (`semester_id`) REFERENCES `semester` (`id`),
  ADD CONSTRAINT `project_tim_id_foreign` FOREIGN KEY (`tim_id`) REFERENCES `tim` (`id`);

--
-- Constraints for table `tasks`
--
ALTER TABLE `tasks`
  ADD CONSTRAINT `tasks_ibfk_1` FOREIGN KEY (`sprint_id`) REFERENCES `sprint` (`id`),
  ADD CONSTRAINT `tasks_ibfk_2` FOREIGN KEY (`kesulitan_id`) REFERENCES `kesulitans` (`id`);

--
-- Constraints for table `tim`
--
ALTER TABLE `tim`
  ADD CONSTRAINT `tim_prodi_id_foreign` FOREIGN KEY (`prodi_id`) REFERENCES `prodi` (`id`),
  ADD CONSTRAINT `tim_semester_id_foreign` FOREIGN KEY (`semester_id`) REFERENCES `semester` (`id`);
COMMIT;
