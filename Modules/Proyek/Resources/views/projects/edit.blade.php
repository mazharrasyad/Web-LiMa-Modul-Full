                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <select name="scrummaster_id" id="scrummaster_id" class="btn btn-secondary dropdown-toggle" type="button">     
                                ...
                                @if($scrummaster->role == "scrum master")
                                    @if ($scrummaster->id == $project->scrummaster_id)
                                        <option value="{{ $project->scrummaster_id }}" selected>{{ $project->scrummaster->name }}</option>
                                    @else
                                        <option value="{{ $scrummaster->id }}">{{ $scrummaster->name }}</option>
                                    @endif         
                                @endif                           
                                @endforeach                     
                            </select>
