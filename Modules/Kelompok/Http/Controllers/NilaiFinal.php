...
class NilaiFinal extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('kelompok::pages.tablesMahasiswa2', ['data'=>$data] );
    }
    ...
    //     $response = $request->getBody();
    //     $data = json_decode($response);
    //     return view('kelompok::pages.createFinal', ['data'=>$data]);
    // }

    public function create2($matkul,$uts) {
            return view('kelompok::pages.createFinal', ['matkul'=>$matkul,'uts'=>$uts]);
        }
